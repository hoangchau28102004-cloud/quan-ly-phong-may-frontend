// File: lib/features/profile/profile_history_screen.dart
import 'dart:convert';
...
class _ProfileHistoryScreenState extends State<ProfileHistoryScreen> {
  ...
  /// Tải lịch sử mượn thiết bị và báo cáo sự cố của người dùng hiện tại.
  /// Endpoints: GET /phieu-muon/ca-nhan  và GET /bao-cao-su-co/ca-nhan
  /// Kết quả gán vào `_borrowHistory` và `_incidentHistory`.
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: _isLoading
            ...
            : TabBarView(
                children: [
                  // Khối danh sách Phiếu mượn thiết bị vuông vức
                  ListView.builder(
                  ...
                  // Khối danh sách Báo lỗi máy tính vuông vức
                  ListView.builder(
                    padding: const EdgeInsets.all(16),
