class CourseSectionModel {
  ...
  CourseSectionModel({
    required this.id, required this.maLopHocPhan, this.maMon, this.tenMon,
    this.maNamHoc, this.tenNamHoc, this.maPhong, this.tenPhong,
    this.maGiangVien, this.tenGiangVien, required this.soSinhVien, required this.siSoToiDa,
    required this.trangThai, this.ghiChu,
  });
