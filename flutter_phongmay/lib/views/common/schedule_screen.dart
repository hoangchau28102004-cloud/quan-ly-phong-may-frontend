...
class _ScheduleScreenState extends State<ScheduleScreen> {
  ...
  DateTime _focusedDay = DateTime.parse(
    '2026-05-20',
  ); // Mock ngày hiện tại theo SQL bạn nhập
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (user != null) {
        ...
        // Nếu là Sinh viên (role=3) thì truyền lopHocId, nếu là Giảng viên thì truyền nguoiDungId
        if (user.vaiTroId == 3) {
          scheduleVM.loadSchedule(1, lopHocId: user.lopHocId); // Load Tuần 1
        } else {
          scheduleVM.loadSchedule(1, nguoiDungId: user.id); // Load Tuần 1
        }
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Lọc danh sách lịch theo ngày được chọn trên Calendar
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              // Actions menu for each schedule item
